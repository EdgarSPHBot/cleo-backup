...
declare -a SECRET_PATTERNS=(
  ...
  's/xoxb-[A-Za-z0-9-]{10,}/[SLACK_BOT_TOKEN]/g'
  's/xapp-[A-Za-z0-9-]{10,}/[SLACK_APP_TOKEN]/g'
  's/xoxp-[A-Za-z0-9-]{10,}/[SLACK_USER_TOKEN]/g'
  's/"botToken"\s*:\s*"[^"]+/"botToken": "[REDACTED_SLACK_BOT_TOKEN]/g'
  's/"appToken"\s*:\s*"[^"]+/"appToken": "[REDACTED_SLACK_APP_TOKEN]/g'
  's/"signingSecret"\s*:\s*"[^"]+/"signingSecret": "[REDACTED_SIGNING_SECRET]/g'
)
